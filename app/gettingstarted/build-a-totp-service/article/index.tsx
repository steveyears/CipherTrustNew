...
const GettingStarted = ({}: GettingStartedProps) => {
  ...
  const getColorClass = (url: string) => {
    if (url.includes("build-a-totp-service")) {
      return "text-[#00BBDD]"; 
    }
    return "text-n-2"; 
  };
    ...
    <Section>
      <div className="container md:py-10 lg:pt-16 xl:pt-20">
        <Heading
          ...
          titleLarge="Build a TOTP service"
          textLarge="Use CipherTrust Manager to build a time-based OTP service for your users&apos; multi-factor authentication"
        />
