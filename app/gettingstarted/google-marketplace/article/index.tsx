...
const GettingStarted = ({}: GettingStartedProps) => {
  ...
  const getColorClass = (url: string) => {
    if (url.includes("google-marketplace")) {
      return "text-[#00BBDD]"; 
    }
    return "text-n-2"; 
  };
    ...
    <Section>
      <div className="container md:py-10 lg:pt-16 xl:pt-20">
        <Heading
          ...
          titleLarge="Google Cloud Marketplace"
          textLarge="Easily deploy CipherTrust Community Edition via Google Cloud Marketplace to leverage robust data security, encryption, and key management capabilities directly within your Google Cloud environment"
        />
