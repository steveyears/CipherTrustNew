...
const GettingStarted = ({}: GettingStartedProps) => {
  ...
  const getColorClass = (url: string) => {
    if (url.includes("azure-command-line")) {
      return "text-[#00BBDD]";
    }
    return "text-n-2";
  };
    ...
    <Section>
      <div className="container md:py-10 lg:pt-16 xl:pt-20">
        <Heading
          ...
          titleLarge="Azure Command Line Interface (CLI)"
          textLarge="Get started with CipherTrust Platform Community Edition automatically on Azure using a Terraform configuration file"
        />
