...
const GettingStarted = ({}: GettingStartedProps) => {
  ...
  const getColorClass = (url: string) => {
    if (url.includes("encrypt-rds-with-aws-kms")) {
      return "text-[#00BBDD]";
    }
    return "text-n-2";
  };
    ...
    <Section>
      <div className="container md:py-10 lg:pt-16 xl:pt-20">
        <Heading
          ...
          titleLarge="Encrypt RDS with AWS KMS"
          textLarge="Easily encrypt your Amazon RDS instances using AWS Key Management Service (KMS) and CipherTrust Manager"
        />
