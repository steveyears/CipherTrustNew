        ...
        <div>
          <div className="inline-flex items-center bg-n-7 rounded-2xl p-6 mb-8 border border-n-1/10">
            <div className="mr-4 min-w-[48px]">
              <Image
                ...
                src={`${basePath}/images/resources/krishna.png`}
                width={60}
                height={60}
          ...
          <p>
            <ul className="body-2 mb-6">
              ...
              <li className="ml-10">
                <Image
                  src={`${basePath}/images/resources/articles/illustration1.webp`}
                  height={1200}
                  width={1200}
                  alt="Illustration"
              ...
              <li className="ml-10">
                <Image
                  src={`${basePath}/images/resources/articles/illustration3.webp`}
                  height={1200}
                  width={1200}
                  alt="Illustration"
                  className="rounded-3xl border border-n-1/10 mb-8"
          ...
          <ul className="body-2 mb-6">
            <li className="flex py-4 mb-6 items-center">
              <Image
                src={`${basePath}/images/resources/articles/icon_automation_white.svg`}
                width={80}
                height={80}
                alt="Automation"
                className="mr-4"
            ...
            <li className="flex items-start py-4 mb-6">
              <Image
                src={`${basePath}/images/resources/articles/icon_key_management.svg`}
                width={80}
                height={80}
                alt="Key Management"
                className="mr-4"
            ...
            <li className="flex items-start py-4 mb-6">
              <Image
                src={`${basePath}/images/resources/articles/icon_node_white.svg`}
                width={80}
                height={80}
                alt="Mulitcloud"
                className="mr-4"
